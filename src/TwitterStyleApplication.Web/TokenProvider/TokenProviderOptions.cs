...
namespace TwitterStyleApplication.Web.TokenProvider
{
	/// <summary>
	...
	public class TokenProviderOptions
	{
		...
		/// </summary>
		/// <remarks>The default is 2 weeks.</remarks>
		...
		/// </summary>
		public Func<string, string, IServiceProvider, Task<ClaimsIdentity>> IdentityResolver { get; set; }
